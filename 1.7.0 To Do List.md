...
Most important ones:
  ...
  - [Test MIDI mappings](Supported%20Controller%20Test%20Grid) for
    ...
    we can
  - Start populating the [change log](development_roadmap#changelog)
    from data in the commit logs
...
## Known Issues / Errata
  ...
  - Windows: You may need to tell Windows to send output to the correct
    device, especially if you hear random notes instead of see lights on
    your controller: Start-\>Settings-\>Control Panel-\>Classic
    View-\>Sounds and Audio Devices-\>Audio Tab, set "MIDI Music
    Playback" at the bottom to the device you're trying to use.
