...
**Remaining blocker bugs for 1.8.0 final**
  ...
  - "scratch" control is asymmetric -
    <https://bugs.launchpad.net/mixxx/+bug/519892>
  - fixes\_scratch merge + fixing vinyl control - To be done in
    fixes\_scratch (RateControl fix for asymmetry and then introducing
    "scratch2" CO) (Sean)
...
### M4A
  ...
  - Solve Windows X64 libfaad2 dll [building
    ...
    file and assemble that separately
