...
``` 
    ...
    * [[https://bugs.launchpad.net/mixxx/+bug/586774|Wrong track duration]]
    * [[https://bugs.launchpad.net/mixxx/+bug/586755|Crash creating new library]]
...
### Engine
  ...
  - ~~Implement alpha-beta smoothing filter in the Engine (currently in
    ...
    - Done in the MidiScriptEngine for relative controls in 1.8.0
