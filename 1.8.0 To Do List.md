...
**Very important remaining tasks for beta1**:
  ...
  - Missing columns in playlist/crate/autodj views
    \[[https://bugs.launchpad.net/mixxx/+bug/500474|Bug](https://bugs.launchpad.net/mixxx/+bug/500474%7CBug)
    500474\]
...
``` 
    ...
    * Reader ASSERT(s)
    * MIDI script engine crash (https://bugs.launchpad.net/mixxx/+bug/493793)
```
