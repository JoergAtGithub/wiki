...
* Play Queue 
    * Right click on a playlist and "Add to play queue" action
    * Right click on track(s) and "Add to play queue" action
    * NEXT mode slurps tracks from play queue
* Library Rescan
...
* Tagging (not file metadata tagging)
    ...
    * Manage view - In progress, Albert
