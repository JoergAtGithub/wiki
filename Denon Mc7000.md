...
## Compatibility
  ...
  - OpenSUSE Tumbleweed is currently on Kernel 5.6.6 supporting the
    MC7000 Audio Interface.
  - Manjaro Linux 20.0 was just released with Linux Kernel 5.4.35
    supporting the MC7000 Audio Interface.
