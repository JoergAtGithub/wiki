...
You can also use
[//qt.nokia.com/products/developer-tools)](/Qt%20Creator%20\(http///qt.nokia.com/products/developer-tools\))
for Mixxx development by creating a Qt project file for the source
files. You can do this by running 'qmake -project' under mixxx/src. When
...
as th project file will not resolve the dependencies.
