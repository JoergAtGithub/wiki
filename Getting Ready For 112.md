...
|  | \[Channel*N*\]    |  | sync\_enabled |  | binary      |  | Press: instant sync; Hold: enable sync mode. Press while sync mode enabled disables sync mode. |  | SYNC button lights & Pitch slider snaps to the appropriate value            |  |
