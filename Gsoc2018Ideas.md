...
means that any changes to the initialization order are likely to
introduce serious bugs. This project would involve refactoring large
parts of the code to create a consistent structure that is easy for
developers to understand and maintain. Also, this project would require
profiling to measure what code in the startup and shutdown processes are
taking lots of time to execute and implementing ways to optimize those
bottlenecks. Refer to the [Mixxx Init Refactor](Mixxx%20Init%20Refactor)
page for more background information and some ideas to get started.
