...
| ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Behringer U-Phono UFO202](http://www.music-group.com/Categories/Behringer/Computer-Audio/Audio-Interfaces/UFO202/p/P0A12)                | $30                | 2            | 2           | Cheapest option for vinyl control, but requires [a small hardware modification](http://mixxx.org/forums/viewtopic.php?f=6&t=2438) and a separate device for each deck. Not to be confused with the Behringer U-Control **UCA**202 & **UCA**222, which do not have phono preamps and cannot be used for vinyl control. |
| [Native Instruments Traktor Audio 2 DJ (Mk2)](http://www.native-instruments.com/en/products/traktor/dj-audio-interfaces/traktor-audio-2/) | $100               | 4            | 0           | Cheap option with the minimum recommended number of output channels. Has no input channels, so it cannot be used for vinyl control.                                                                                                                                                                                   |
| [ESI Maya 44 USB+](http://www.esi-audio.com/products/maya44usb+/)                                                                         | $140               | 4            | 4           | Works for vinyl control.                                                                                                                                                                                                                                                                                              |
| [Focusrite Scarlett 2i4](http://us.focusrite.com/usb-audio-interfaces/scarlett-2i4)                                                       | $180               | 4            | 2           | Good balance of sound quality and price. Can be used with live inputs (like microphones for radio broadcasting). Balanced outputs can plug directly into a PA system without needing external mixer.                                                                                                                  |
| [Roland Rubix24](https://www.roland.com/us/products/rubix24/)                                                                             | $200               | 4            | 2           | Can be used with live inputs (like microphones for radio broadcasting). Has hardware compressors on the inputs that can be used with direct monitoring. Balanced outputs can plug directly into a PA system without needing external mixer.                                                                           |
