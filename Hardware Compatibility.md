...
| [Focusrite Scarlett 2i4](http://us.focusrite.com/usb-audio-interfaces/scarlett-2i4)                                                       | $180               | 4            | 2           | Good balance of sound quality and price. Balanced outputs can plug directly into a PA system without needing an external mixer. Can be used with live inputs (like microphones for radio broadcasting or playing guitar along with DJing), but only has 2 input channels, which could only support one timecode vinyl deck.                                                             |
...
| [MOTU Ultralite AVB](http://motu.com/products/avb/ultralite-avb/)                                                                         | $650               | 10           | 10          | High quality balanced outputs can plug directly into a PA system and booth monitors with independent volume control without needing an external mixer. Can be used with live inputs (like microphones for radio broadcasting or playing guitar along with DJing) and vinyl control at the same time. Also works as WiFi controllable mixer with DSP effects without needing a computer. |
