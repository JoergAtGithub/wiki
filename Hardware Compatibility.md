...
| [Stanton SCS.1d](Stanton%20SCS.1d)                               | Yes (1.9.1)                             | Yes (1.9.1)                | In progress (ALSA kernel patch)                                                                                                               |
...
| [Hercules DJ Control Steel](Hercules%20PC%20DJ%20Console)                                          | Yes (1.7.0+)            | Yes (1.7.0+)                                            | Yes (1.7.0+ ) + \[11\] [Hercules Linux kernel module](hercules_linux_kernel_module)                                                                                                                                                                     |
| [Hercules DJ Console Mk1](Hercules%20PC%20DJ%20Console)                                            | No                      | No                                                      | No\[12\]                                                                                                                                                                                                                                                |
| [Hercules DJ Console Mac Edition](Hercules%20PC%20DJ%20Console)                                    | Yes (1.7.0+)            | Yes (1.7.0+)                                            | ???                                                                                                                                                                                                                                                     |
| [Hercules DJ Control MP3](Hercules_PC_DJ_Console)                                                  | Yes (1.7.0+)            | Yes (1.7.0+)                                            | Yes (1.7.0+) + \[13\] [Hercules Linux MIDI Driver](http://ts.hercules.com/eng/index.php?% Apg=view_files&gid=2&fid=28&pid=215&cid=1#section1)                                                                                                           |
| [Hercules DJ Console Mk4](Hercules%20PC%20DJ%20Console)                                            | Yes (1.8.2+)            | Yes (1.8.2+)                                            | No way to test it \[14\] For any news see [here](http://www.mixxx.org/forums/viewtopic.php?f=1&t=1560)                                                                                                                                                  |
...
| [Tascam US-428](Tascam%20US-428)                                                                   | MIDI (1.6.0+, untested) | ?                                                       | Yes\[15\]                                                                                                                                                                                                                                               |
...
11. official driver must be patched to support kernels \> 2.6.30 see
    <http://mixxx.org/forums/viewtopic.php?f=1&t=851>

12. Driver conflict between Linux kernel usbquirks and Herc MIDI driver

13. official driver must be patched to support kernels \> 2.6.30 see
    <http://mixxx.org/forums/viewtopic.php?f=1&t=851>

14. hercules mk4 linux MIDI driver missing

15. Need the latest us428control (launch us428control -m mixxx) and the
