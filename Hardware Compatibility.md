...
| [Focusrite Scarlett 2i4](http://us.focusrite.com/usb-audio-interfaces/scarlett-2i4)                                                       | $180               | 4            | 2           | Good balance of sound quality and price. Can be used with live inputs (like microphones for radio broadcasting or playing guitar along with DJing). Balanced outputs can plug directly into a PA system without needing external mixer.                                                                                                                               |
| [Roland Rubix24](https://www.roland.com/us/products/rubix24/)                                                                             | $200               | 4            | 2           | Can be used with live inputs (like microphones for radio broadcasting or playing guitar along with DJing). Has hardware compressors on the inputs that can be used with direct monitoring. Balanced outputs can plug directly into a PA system without needing external mixer.                                                                                        |
