...
| [Keith McMillen Instruments QuNeo](keith_mcmillen_quneo)         | Yes (1.11.0+)                           | Yes (1.11.0+)              | Yes (1.11.0+)                                                                                                                                 |
...
| [Vestax VCI-400](Vestax%20VCI-400)                               | Yes (1.10.1)                            | Yes (1.10.1)               | Untested (1.10.1)                                                                                                                             |
...
| [Hercules DJ Control Steel](Hercules%20PC%20DJ%20Console)                                          | Yes (1.7.0+)   | Yes (1.7.0+)                                            | Yes (1.7.0+ ) + \[12\] [Hercules Linux kernel module](hercules_linux_kernel_module)                                                                                                                                                                     |
...
| [Reloop Digital Jockey 2 Master Edition](Reloop%20Digital%20Jockey%202%20Master%20Edition)         | Yes (1.8.0+)   | Yes (1.8.0+)                                            | No \[15\]                                                                                                                                                                                                                                               |
