...
| [MOTU M4](https://motu.com/en-us/products/m-series/m4/)                                                                                | $220               | 4            | yes              | 4           | yes                                     | no           | Best sound quality before spending much more money. Has microphone inputs with direct monitoring and loopback for [easy setup](https://mixxx.org/manual/latest/en/chapters/microphones.html#direct-monitoring). Convenient level meters on the front of the device. Loopback not available on Linux, but mic inputs can still be used. Also, may [require using JACK](https://panther.kapsi.fi/posts/2020-02-02_motu_m4) to work fully on Linux. |
