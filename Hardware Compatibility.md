...
| [Reloop Digital Jockey 2 Master Edition](Reloop%20Digital%20Jockey%202%20Master%20Edition)         | Yes (1.8.0+)            | Yes (1.8.0+)                                            | No \[12\]                                                                                                                                                                                                                                               |
| [Hercules DJ Control Steel](Hercules%20PC%20DJ%20Console)                                          | Yes (1.7.0+)            | Yes (1.7.0+)                                            | Yes (1.7.0+ ) + \[13\] [Hercules Linux kernel module](hercules_linux_kernel_module)                                                                                                                                                                     |
| [Hercules DJ Console Mk1](Hercules%20PC%20DJ%20Console)                                            | No                      | No                                                      | No\[14\]                                                                                                                                                                                                                                                |
| [Hercules DJ Console Mac Edition](Hercules%20PC%20DJ%20Console)                                    | Yes (1.7.0+)            | Yes (1.7.0+)                                            | ???                                                                                                                                                                                                                                                     |
| [Hercules DJ Control MP3](Hercules_PC_DJ_Console)                                                  | Yes (1.7.0+)            | Yes (1.7.0+)                                            | Yes (1.7.0+) + \[15\] [Hercules Linux MIDI Driver](http://ts.hercules.com/eng/index.php?% Apg=view_files&gid=2&fid=28&pid=215&cid=1#section1)                                                                                                           |
| [Hercules DJ Console Mk4](Hercules%20PC%20DJ%20Console)                                            | Yes (1.8.2+)            | Yes (1.8.2+)                                            | No way to test it \[16\] For any news see [here](http://www.mixxx.org/forums/viewtopic.php?f=1&t=1560)                                                                                                                                                  |
...
| [Tascam US-428](Tascam%20US-428)                                                                   | MIDI (1.6.0+, untested) | ?                                                       | Yes\[17\]                                                                                                                                                                                                                                               |
...
13. official driver must be patched to support kernels \> 2.6.30 see
    <http://mixxx.org/forums/viewtopic.php?f=1&t=851>

14. Driver conflict between Linux kernel usbquirks and Herc MIDI driver

15. official driver must be patched to support kernels \> 2.6.30 see
    <http://mixxx.org/forums/viewtopic.php?f=1&t=851>

16. hercules mk4 linux MIDI driver missing

17. Need the latest us428control (launch us428control -m mixxx) and the
