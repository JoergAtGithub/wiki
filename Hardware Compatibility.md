...
| [Hercules DJ Console Mac Edition\] | MIDI (1.6.0) | MIDI (untested) | libDJConsole (1.6.0) \[2\] | ^ \[\[Hercules\_PC\_DJ\_Console|Hercules DJ Control MP3](Hercules%20PC%20DJ%20Console) | MIDI (1.6.0, untested)                              | MIDI (untested)       | HerculesLegacy (1.5.0) \[3\] via /dev/inputX device files                                                                                                        |
