...
| [Native Instruments Traktor Audio 2 DJ (Mk2)](http://www.native-instruments.com/en/products/traktor/dj-audio-interfaces/traktor-audio-2/) | $100               | 4            | 0           | Has the minimum recommended number of output channels, but no input channels, so it cannot be used for vinyl control.                                                                                                                                                                                                                                                                                |
...
| [Focusrite Scarlett 2i4](http://us.focusrite.com/usb-audio-interfaces/scarlett-2i4)                                                       | $180               | 4            | 2           | Good balance of sound quality and price. Balanced outputs can plug directly into a PA system without needing an external mixer. Can be used with live inputs (like microphones for radio broadcasting), but only has 2 input channels, which could only support one timecode vinyl deck.                                                                                                             |
| [Roland Rubix24](https://www.roland.com/us/products/rubix24/)                                                                             | $200               | 4            | 2           | Similar to the Focusrite Scarlett 2i4, but has a hardware compressor on the inputs that can be used with direct monitoring.                                                                                                                                                                                                                                                                          |
