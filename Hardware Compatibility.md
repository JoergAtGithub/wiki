...
| [Behringer BCD3000](Behringer%20BCD3000)\[1\]                    | Yes (1.6.0, untested)                                | Yes (1.6.0, untested)                                   | Yes (1.6.0)                                                                                                                                                                                                                                             | Yes                |
| [Stanton SCS.1 series](http://www.enterthesystem.com/system/)    | Waiting on Stanton for programming info & test units | Ditto                                                   | Ditto                                                                                                                                                                                                                                                   | No                 |
| [Stanton SCS.3d](http://www.enterthesystem.com/system/scs3d/)    | 1.6.1 (with DaRouter,) Yes (1.6.2)                   | 1.6.1 (with DaRouter,) Yes (1.6.2)                      | Yes (1.6.2)                                                                                                                                                                                                                                             | Yes                |
...
| [Eks Otus](Eks%20Otus)                                           | Yes\[2\] (untested)                                  | Yes\[3\] (untested)                                     | Yes\[4\] (untested)                                                                                                                                                                                                                                     | No                 |
...
2.  Compatible with any software that supports MIDI learn, in Linux/Mac
    OS X/Windows: <http://eks.fi/product.php?p=products&id=35>

3.  Compatible with any software that supports MIDI learn, in Linux/Mac
    OS X/Windows: <http://eks.fi/product.php?p=products&id=35>
