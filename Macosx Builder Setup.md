...
and PPC. Mac OS 10.4 is no longer supported.
...
**This entire process is now migrated to actual scripts in our
buildserver repository. You can view these scripts here: [Mac OS X
Builder Setup
Scripts](https://github.com/mixxxdj/buildserver/tree/master/scripts/macosx)**
