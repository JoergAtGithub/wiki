...
|  | \[Channel*N*\] |  | beatloop\_(X)\[24\]           |  | 0.0 / 1.0 (PushButton) |  | Setup a loop over X beats. A control exists for X = 0.0625, 0.125, 0.25, 0.5, 1, 2, 4, 8, 16, 32, 64                  |  | A loop is shown over X beats.                                                           |  |
