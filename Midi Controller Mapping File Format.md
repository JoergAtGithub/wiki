...
|  | \[Channel*N*\]     |  | loop\_in\_position\*         |  | positive integer  |  | The player loop-in position in samples, -1 if not set.                                                                                                                                              |  | Loop-in marker changes on waveform.                                 |  |
...
|  | \[Channel*N*\]     |  | loop\_out\_position\*        |  | positive integer  |  | The player loop-out position in samples, -1 if not set.                                                                                                                                             |  | Loop-out marker shows on waveform.                                  |  |
|  | \[Channel*N*\]     |  | NextTask                     |  | ?                 |  | ?                                                                                                                                                                                                   |  | ?                                                                   |  |
|  | \[Channel*N*\]     |  | NextTrack                    |  | ?                 |  | ?                                                                                                                                                                                                   |  | ?                                                                   |  |
