...
<sup>3</sup> changed in Mixxx v1.9.1
...
|  | \[Channel*N*\]   |  | beatloop\_(X)<sup>4</sup>            |  | 0.0 / 1.0 (PushButton) |  | Setup a loop over X beats. A control exists for X = 0.0625, 0.125, 0.25, 0.5, 1, 2, 4, 8, 16, 32, 64                                                                                                                                                                                              |  | A loop is shown over X beats.                                                                                                                                                                                                                                                                                                                 |  |
|  | \[Channel*N*\]   |  | quantize<sup>4</sup>                 |  | 0.0 / 1.0 (PushButton) |  | Aligns Hotcues, CUE and Loop In & Out to the next beat starting from the current position.                                                                                                                                                                                                        |  | Hotcues, CUE and Loop In & Out are aligned to the next beat from the previous position.                                                                                                                                                                                                                                                       |  |
