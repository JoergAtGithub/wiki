...
|  | \[Sampler*N*\]   |  | LoadSelectedTrack                    |  | binary              |  | Loads the currently highlighted track into the sampler                                                                                                                                                                                                                                            |  | Track name & waveform change                                                                                                                                                                                                                                                                                                                  |  |
...
|  | \[Channel*N*\]   |  | beatsync                             |  | binary              |  | **changed behavior** Syncs the BPM and phase to that of the other track (if BPM is detected on both)                                                                                                                                                                                              |  | SYNC button & Pitch slider snaps to the appropriate value                                                                                                                                                                                                                                                                                     |  |
|  | \[Channel*N*\]   |  | beatsync\_tempo                      |  | binary              |  | Syncs the BPM to that of the other track (if BPM is detected on both)                                                                                                                                                                                                                             |  | SYNC button & Pitch slider snaps to the appropriate value                                                                                                                                                                                                                                                                                     |  |
|  | \[Channel*N*\]   |  | beatsync\_phase                      |  | binary              |  | Syncs the phase to that of the other track (if BPM is detected on both)                                                                                                                                                                                                                           |  | SYNC button & Pitch slider snaps to the appropriate value                                                                                                                                                                                                                                                                                     |  |
