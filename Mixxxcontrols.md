...
| \[EffectRack1\_EffectUnitN\] \[143\]          |  | focused\_effect              |  | 0-4                  |  | 0 indicates no effect is focused; \>0 indicates the number of the focused effect. Focusing an effect only does something if a controller mapping changes how it behaves when an effect is focused. |  |
...
| \[EffectRack1\_EffectUnitN\] \[144\]          |  | show\_focus                  |  | binary               |  | Whether to show focus buttons and draw a border around the focused effect in skins.                                                                                                                |  |
