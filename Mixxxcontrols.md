...
| end\_of\_track                           |  | binary, read-only             |  | Switches to "1" if the play osition is within the 'end' range defined in Preferences \> Waveforms \> "End of track warning"                                                                                                                                                                       |  | Waveform and Overview widgets show a flashing border                                                                                                                               |  |
...
| hotcue\_X\_color\[65\]                   |  | 3-Byte RGB color code (or -1) |  | Color of hotcue X or -1 if the hotcue is not set.                                                                                                                                                                                                                                                 |  | Color of Hotcue X button and waveform marker changes.                                                                                                                              |  |
| hotcue\_X\_enabled\[66\]                 |  | read-only, binary             |  | 1 if hotcue X is active, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                       |  |                                                                                                                                                                                    |  |
| hotcue\_X\_goto\[67\]                    |  | binary                        |  | If hotcue X is set, seeks the player to hotcue X's position.                                                                                                                                                                                                                                      |  | Player may change position.                                                                                                                                                        |  |
| hotcue\_X\_gotoandplay\[68\]             |  | binary                        |  | If hotcue X is set, seeks the player to hotcue X's position and starts playback.                                                                                                                                                                                                                  |  | Player may change position.                                                                                                                                                        |  |
| hotcue\_X\_gotoandstop\[69\]             |  | binary                        |  | If hotcue X is set, seeks the player to hotcue X's position and stops.                                                                                                                                                                                                                            |  | Player may change position.                                                                                                                                                        |  |
| hotcue\_X\_position\[70\]                |  | positive integer              |  | The position of hotcue X in samples, -1 if not set.                                                                                                                                                                                                                                               |  | Hotcue X marker changes on waveform.                                                                                                                                               |  |
| hotcue\_X\_set\[71\]                     |  | binary                        |  | Set hotcue X to the current play position. If hotcue X was previously set, clears its hotcue status.                                                                                                                                                                                              |  | Hotcue X marker changes on waveform.                                                                                                                                               |  |
| hotcue\_focus\[72\]                      |  | positive integer (or -1)      |  | Contains the number of the most recentlly used hotcue (or -1 if no hotcue was used)                                                                                                                                                                                                               |  | N/A                                                                                                                                                                                |  |
| hotcue\_focus\_color\_prev\[73\]         |  | binary                        |  | If there is a focused hotcue, sets its color to the previous color in the palette.                                                                                                                                                                                                                |  | Color of focused hotcue button and waveform marker changes.                                                                                                                        |  |
| hotcue\_focus\_color\_next\[74\]         |  | binary                        |  | If there is a focused hotcue, sets its color to the next color in the palette.                                                                                                                                                                                                                    |  | Color of focused hotcue button and waveform marker changes.                                                                                                                        |  |
| intro\_end\_activate\[75\]               |  | binary                        |  | If the intro end cue is set, seeks the player to the intro end position. If the intro end is not set, sets the intro end to the current play position.                                                                                                                                            |  | Player may change position. Intro end marker may change on waveform.                                                                                                               |  |
| intro\_end\_clear\[76\]                  |  | binary                        |  | If the intro end cue is set, clears its status.                                                                                                                                                                                                                                                   |  | Intro end marker changes on waveform.                                                                                                                                              |  |
| intro\_end\_enabled\[77\]                |  | read-only, binary             |  | 1 if intro end cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                     |  | Intro end button lights up.                                                                                                                                                        |  |
| intro\_end\_position\[78\]               |  | positive integer              |  | The position of the intro end in samples, -1 if not set.                                                                                                                                                                                                                                          |  | Intro end marker changes on waveform.                                                                                                                                              |  |
| intro\_end\_set\[79\]                    |  | binary                        |  | Set intro end to the current play position. If intro end was previously set, it is moved to the new position.                                                                                                                                                                                     |  | Intro end marker changes on waveform.                                                                                                                                              |  |
| intro\_start\_activate\[80\]             |  | binary                        |  | If the intro start cue is set, seeks the player to the intro start position. If the intro start is not set, sets the intro start to the current play position.                                                                                                                                    |  | Player may change position. Intro start marker may change on waveform.                                                                                                             |  |
| intro\_start\_clear\[81\]                |  | binary                        |  | If the intro start cue is set, clears its status.                                                                                                                                                                                                                                                 |  | Intro start marker changes on waveform.                                                                                                                                            |  |
| intro\_start\_enabled\[82\]              |  | read-only, binary             |  | 1 if intro start cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                   |  | Intro start button lights up.                                                                                                                                                      |  |
| intro\_start\_position\[83\]             |  | positive integer              |  | The position of the intro start in samples, -1 if not set.                                                                                                                                                                                                                                        |  | Intro start marker changes on waveform.                                                                                                                                            |  |
| intro\_start\_set\[84\]                  |  | binary                        |  | Set intro start to the current play position. If intro start was previously set, it is moved to the new position.                                                                                                                                                                                 |  | Intro start marker changes on waveform.                                                                                                                                            |  |
...
| loop\_double\[88\]                       |  | binary                        |  | Doubles beatloop\_size. If beatloop\_size equals the size of the loop, the loop is resized. \[89\]                                                                                                                                                                                                |  | beatloop\_size spinbox changes                                                                                                                                                     |  |
| loop\_enabled\[90\]                      |  | read-only, binary             |  | Indicates whether or not a loop is enabled. Read-only, do not set.                                                                                                                                                                                                                                |  | Loop in waveform is active.                                                                                                                                                        |  |
| loop\_end\_position\[91\]                |  | positive integer              |  | The player loop-out position in samples, -1 if not set.                                                                                                                                                                                                                                           |  | Loop-out marker shows on waveform.                                                                                                                                                 |  |
| loop\_halve\[92\]                        |  | binary                        |  | Halves beatloop\_size. If beatloop\_size equals the size of the loop, the loop is resized. \[93\]                                                                                                                                                                                                 |  | beatloop\_size spinbox changes                                                                                                                                                     |  |
| loop\_in\[94\]                           |  | binary                        |  | If loop is disabled, sets the player loop in position to the current play position. If loop is enabled, press and hold to move loop in position to the current play position. If quantize is enabled, beatloop\_size will be updated to reflect the new loop size. \[95\]                         |  | Loop-in marker changes on waveform.                                                                                                                                                |  |
| loop\_in\_goto\[96\]                     |  | binary                        |  | Seek to the loop in point.                                                                                                                                                                                                                                                                        |  | Waveform position jumps                                                                                                                                                            |  |
| loop\_out\[97\]                          |  | binary                        |  | If loop is disabled, sets the player loop out position to the current play position. If loop is enabled, press and hold to move loop out position to the current play position. If quantize is enabled, beatloop\_size will be updated to reflect the new loop size. \[98\]                       |  | Loop-out marker changes on waveform.                                                                                                                                               |  |
| loop\_out\_goto\[99\]                    |  | binary                        |  | Seek to the loop out point.                                                                                                                                                                                                                                                                       |  | Waveform position jumps                                                                                                                                                            |  |
| loop\_move\[100\]                        |  | real number                   |  | Move loop forward by X beats (positive) or backward by X beats (negative).                                                                                                                                                                                                                        |  | Loop moves forward or backward by X beats.                                                                                                                                         |  |
| loop\_move\_X\_forward\[101\]            |  | binary                        |  | Moves the loop in and out points forward by X beats. A control exists for X = 0.03125, 0.0625, 0.125, 0.25, 0.5, 1, 2, 4, 8, 16, 32, 64                                                                                                                                                           |  | Loop moves forward by X beats.                                                                                                                                                     |  |
| loop\_move\_X\_backward\[102\]           |  | binary                        |  | Loop moves by X beats. A control exists for X = 0.03125, 0.0625, 0.125, 0.25, 0.5, 1, 2, 4, 8, 16, 32, 64                                                                                                                                                                                         |  | Loop moves backward by X beats.                                                                                                                                                    |  |
| loop\_scale\[103\]                       |  | 0.0 - infinity                |  | Scale the loop length by the value scale is set to by moving the end marker. beatloop\_size is not updated to reflect the change.                                                                                                                                                                 |  | Loop length is scaled by given amount on waveform.                                                                                                                                 |  |
| loop\_start\_position\[104\]             |  | positive integer              |  | The player loop-in position in samples, -1 if not set.                                                                                                                                                                                                                                            |  | Loop-in marker changes on waveform.                                                                                                                                                |  |
...
| outro\_end\_activate\[106\]              |  | binary                        |  | If the outro end cue is set, seeks the player to the outro end position. If the outro end is not set, sets the outro end to the current play position.                                                                                                                                            |  | Player may change position. Outro end marker may change on waveform.                                                                                                               |  |
| outro\_end\_clear\[107\]                 |  | binary                        |  | If the outro end cue is set, clears its status.                                                                                                                                                                                                                                                   |  | Outro end marker changes on waveform.                                                                                                                                              |  |
| outro\_end\_enabled\[108\]               |  | read-only, binary             |  | 1 if outro end cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                     |  | Outro end button lights up.                                                                                                                                                        |  |
| outro\_end\_position\[109\]              |  | positive integer              |  | The position of the outro end in samples, -1 if not set.                                                                                                                                                                                                                                          |  | Outro end marker changes on waveform.                                                                                                                                              |  |
| outro\_end\_set\[110\]                   |  | binary                        |  | Set outro end to the current play position. If outro end was previously set, it is moved to the new position.                                                                                                                                                                                     |  | Outro end marker changes on waveform.                                                                                                                                              |  |
| outro\_start\_activate\[111\]            |  | binary                        |  | If the outro start cue is set, seeks the player to the outro start position. If the outro start is not set, sets the outro start to the current play position.                                                                                                                                    |  | Player may change position. Outro start marker may change on waveform.                                                                                                             |  |
| outro\_start\_clear\[112\]               |  | binary                        |  | If the outro start cue is set, clears its status.                                                                                                                                                                                                                                                 |  | Outro start marker changes on waveform.                                                                                                                                            |  |
| outro\_start\_enabled\[113\]             |  | read-only, binary             |  | 1 if outro start cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                   |  | Outro start button lights up.                                                                                                                                                      |  |
| outro\_start\_position\[114\]            |  | positive integer              |  | The position of the outro start in samples, -1 if not set.                                                                                                                                                                                                                                        |  | Outro start marker changes on waveform.                                                                                                                                            |  |
| outro\_start\_set\[115\]                 |  | binary                        |  | Set outro start to the current play position. If outro start was previously set, it is moved to the new position.                                                                                                                                                                                 |  | Outro start marker changes on waveform.                                                                                                                                            |  |
...
| pitch\_up\[118\]                         |  | binary                        |  | Changes the track pitch up one half step, independent of the tempo.                                                                                                                                                                                                                               |  | Key display                                                                                                                                                                        |  |
| pitch\_down\[119\]                       |  | binary                        |  | Changes the track pitch down one half step, independent of the tempo.                                                                                                                                                                                                                             |  | Key display                                                                                                                                                                        |  |
| pitch\_adjust\[120\]                     |  | \-3.0..3.0                    |  | Adjust the pitch in addition to the speed slider pitch.                                                                                                                                                                                                                                           |  | Key display                                                                                                                                                                        |  |
...
| play\_indicator\[121\]                   |  | binary                        |  | Provides information to be bound with the a Play/Pause button e.g blinking when play is possible                                                                                                                                                                                                  |  | Play/pause button                                                                                                                                                                  |  |
| play\_stutter\[122\]                     |  | binary                        |  | A play button without pause. Pushing while playing, starts play at cue point again (Stutter).                                                                                                                                                                                                     |  | Play/Stutter button                                                                                                                                                                |  |
...
| quantize\_beat\[124\]                    |  | deprecated                    |  | ?                                                                                                                                                                                                                                                                                                 |  | Is used internally by CueControl (CUEs & Hotcues) and LoopingControl for quantization.                                                                                             |  |
...
| reloop\_andstop\[125\]                   |  | binary                        |  | Activate current loop, jump to its loop in point, and stop playback.                                                                                                                                                                                                                              |  | Loop range in waveform activates or deactivates and play position moves to loop in point.                                                                                          |  |
| reloop\_toggle\[126\]                    |  | binary                        |  | Toggles the current loop on or off. If the loop is ahead of the current play position, the track will keep playing normally until it reaches the loop.                                                                                                                                            |  | Loop range in waveform activates or deactivates.                                                                                                                                   |  |
| repeat\[127\]                            |  | binary                        |  | Enable repeat-mode for the specified deck                                                                                                                                                                                                                                                         |  | when track finishes, song loops to beginning                                                                                                                                       |  |
| reset\_key\[128\]                        |  | binary                        |  | Resets the key to the original track key.                                                                                                                                                                                                                                                         |  |                                                                                                                                                                                    |  |
...
| scratch2\_enable\[131\]                  |  | binary                        |  | Takes over play speed & direction for *scratch2*.                                                                                                                                                                                                                                                 |  | Waveform                                                                                                                                                                           |  |
| slip\_enabled\[132\]                     |  | binary                        |  | Toggles slip mode. When active, the playback continues muted in the background during a loop, scratch etc. Once disabled, the audible playback will resume where the track would have been.                                                                                                       |  | Slip mode button                                                                                                                                                                   |  |
| stars\_up\[133\]                         |  | binary                        |  | Increase the rating of the currently loaded track (if the skin has star widgets in the decks section)                                                                                                                                                                                             |  | Star count is increased in the deck's star widget and in the library table                                                                                                         |  |
| stars\_down\[134\]                       |  | binary                        |  | Decrease the rating of the currently loaded track (if the skin has star widgets in the decks section)                                                                                                                                                                                             |  | Star count is decreased in the deck's star widget and in the library table                                                                                                         |  |
| start                                    |  | binary                        |  | Jump to start of track                                                                                                                                                                                                                                                                            |  | Track jumps to start                                                                                                                                                               |  |
| start\_play\[135\]                       |  | binary                        |  | Start playback from the beginning of the deck.                                                                                                                                                                                                                                                    |  | Deck plays from beginning                                                                                                                                                          |  |
| start\_stop\[136\]                       |  | binary                        |  | Seeks a player to the start and then stops it.                                                                                                                                                                                                                                                    |  | Deck stops at the beginning                                                                                                                                                        |  |
| stop\[137\]                              |  | binary                        |  | Stops a player.                                                                                                                                                                                                                                                                                   |  | Pause Button. Deck pauses at the current position                                                                                                                                  |  |
| sync\_enabled\[138\]                     |  | binary                        |  | Syncs the BPM and phase (depending on quantize) to that of the other track (if BPM is detected on both). Click & hold for at least one second activates Master sync on that deck.                                                                                                                 |  | SYNC button & Speed slider snaps to the appropriate value. If pressed and held, SYNC button stays lit and slider adjustments are linked on all decks that have SYNC enabled.       |  |
| sync\_master\[139\]                      |  | binary                        |  | Sets deck as master clock. (NOTE: Through version 2.3 this button just enables master sync mode (similar to sync\_enabled), it does not actually guarantee the deck will be master. This will be fixed in a future version)                                                                       |  | SYNC button will light up and stay lit & Speed slider snaps to the appropriate value. SYNC button stays lit and slider adjustments are linked on all decks that have SYNC enabled. |  |
| sync\_mode\[140\]                        |  | binary                        |  | SYNC\_NONE = 0; SYNC\_FOLLOWER = 1; SYNC\_MASTER = 2,                                                                                                                                                                                                                                             |  |                                                                                                                                                                                    |  |
| sync\_key\[141\]                         |  | ?                             |  | Match musical key                                                                                                                                                                                                                                                                                 |  | Key value widget                                                                                                                                                                   |  |
| track\_color\[142\]                      |  | 3-Byte RGB color code (or -1) |  | Color of the currently loaded track or -1 if no track is loaded or the track has no color.                                                                                                                                                                                                        |  | Track color changes in the library view.                                                                                                                                           |  |
| track\_loaded\[143\]                     |  | binary                        |  | (Read-only) Whether a track is loaded in the specified deck                                                                                                                                                                                                                                       |  | Waveform and track metadata shown in deck                                                                                                                                          |  |
| track\_samplerate\[144\]                 |  | absolute value                |  | (Read-only) Sample rate of the track loaded on the specified deck                                                                                                                                                                                                                                 |  | n/a                                                                                                                                                                                |  |
...
| vinylcontrol\_enabled\[146\]             |  | binary                        |  | Toggles whether a deck is being controlled by digital vinyl                                                                                                                                                                                                                                       |  | When enabled, a vinyl indication should appear onscreen indicating green for Enabled                                                                                               |  |
| vinylcontrol\_cueing\[147\]              |  | 0.0-2.0                       |  | Determines how cue points are treated in vinyl control Relative mode                                                                                                                                                                                                                              |  | Off - cue points ignored; One Cue - If needle is dropped after the cue point, track will seek to that cue point; hot cue - track will seek to nearest previous hot cue point       |  |
| vinylcontrol\_mode\[148\]                |  | 0.0-2.0                       |  | Determines how vinyl control interprets needle information: absolute mode - track position equals needle position and speed; relative mode - track speed equals needle speed regardless of needle position; constant mode - track speed equals last known-steady speed regardless of needle input |  | 3-way button indicates status                                                                                                                                                      |  |
| vinylcontrol\_status\[149\]              |  | 0.0-3.0 (read-only)           |  | Provides visual feedback with regards to vinyl control status                                                                                                                                                                                                                                     |  | Off for control disabled, green for control enabled, blinking yellow for when the needle reaches the end of the record, and red for needle skip detected                           |  |
| visual\_bpm\[150\]                       |  | ?                             |  | BPM to display in the UI (updated more slowly than the actual bpm)                                                                                                                                                                                                                                |  | BPM value widget                                                                                                                                                                   |  |
| visual\_key\[151\]                       |  | ?                             |  | Current musical key after pitch shifting to display in the UI using the notation selected in the preferences                                                                                                                                                                                      |  | Key value widget                                                                                                                                                                   |  |
| visual\_key\_distance\[152\]             |  | \-0.5..0.5                    |  | The distance to the nearest key measured in cents                                                                                                                                                                                                                                                 |  | Key value widget                                                                                                                                                                   |  |
...
| waveform\_zoom\[153\]                    |  | 1.0 - 10.0                    |  | Zooms the waveform to look ahead or back as needed.                                                                                                                                                                                                                                               |  | Waveform zoom buttons                                                                                                                                                              |  |
| waveform\_zoom\_up\[154\]                |  | ?                             |  | Waveform Zoom Out                                                                                                                                                                                                                                                                                 |  | Waveform zoom buttons                                                                                                                                                              |  |
| waveform\_zoom\_down\[155\]              |  | ?                             |  | Waveform Zoom In                                                                                                                                                                                                                                                                                  |  | Waveform zoom buttons                                                                                                                                                              |  |
| waveform\_zoom\_set\_default\[156\]      |  | ?                             |  | Return to default waveform zoom level                                                                                                                                                                                                                                                             |  | Waveform zoom buttons                                                                                                                                                              |  |
...
|  | shuffle\_playlist\[169\] |  | binary |  | Shuffles the content of the Auto DJ playlist. |  | Order of tracks in the AutoDJ playlist changes.    |  |
|  | skip\_next\[170\]        |  | binary |  | Skips the next track in the Auto DJ playlist. |  | Skipped track is removed from the AutoDJ playlist. |  |
|  | fade\_now\[171\]         |  | binary |  | Triggers the transition to the next track.    |  | Crossfader slider moves to the other side.         |  |
...
| font\_size\_increment\[187\] |  | Binary          |  | Increase the size of the library font. If the row height is smaller than the font-size the larger of the two is used.                                             |  | Library view                                               |  |
| font\_size\_decrement\[188\] |  | Binary          |  | Decrease the size of the library font                                                                                                                             |  | Library view                                               |  |
| font\_size\_knob\[189\]      |  | Relative        |  | Increase or decrease the size of the library font                                                                                                                 |  | Library view                                               |  |
| sort\_column\[190\]          |  | See table below |  | Indicates the sorting column the track table                                                                                                                      |  | Sorting indicator in the column headers of the track table |  |
| sort\_column\_toggle\[191\]  |  | See table below |  | Equivalent to clicking on column headers. A new value sets sort\_column to that value and sort\_order to 0, setting the same value again will toggle sort\_order. |  | Sorting indicator in the column headers of the track table |  |
| sort\_order\[192\]           |  | Binary          |  | Indicate the sort order of the track table (0 for ascending, 1 for descending)                                                                                    |  | Sorting indicator in the column headers of the track table |  |
| track\_color\_prev\[193\]    |  | Binary          |  | Set color of selected track to previous color in palette.                                                                                                         |  | Track color changes in the library view.                   |  |
| track\_color\_next\[194\]    |  | Binary          |  | Set color of selected track to next color in palette.                                                                                                             |  | Track color changes in the library view.                   |  |
...
|  | Key/Control             |  | Range  |  | What it does                                                                                                                                                                                                   |  | On-screen feedback |  |
|  | ----------------------- |  | ------ |  | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |  | ------------------ |  |
|  | touch\_shift\[195\]     |  | binary |  | Once enabled, all touch tab events are interpreted as right click. This control has been added to provide touchscreen compatibility in 2.0 and might be replaced by a general modifier solution in the future. |  | All Widgets        |  |
...
| \[EffectRack1\_EffectUnitN\] \[197\]          |  | focused\_effect              |  | 0..num\_effects      |  | 0 indicates no effect is focused; \> 0 indicates the index of the focused effect. Focusing an effect only does something if a controller mapping changes how it behaves when an effect is focused. |  |
...
| \[EffectRack1\_EffectUnitN\] \[198\]          |  | show\_focus                  |  | binary               |  | Whether to show focus buttons and draw a border around the focused effect in skins. This should not be manipulated by skins; it should only be changed by controller mappings.                     |  |
| \[EffectRack1\_EffectUnitN\] \[199\]          |  | show\_parameters             |  | binary               |  | Whether to show all the parameters of each effect in skins or only show metaknobs.                                                                                                                 |  |
...
| \[EffectRack1\_EffectUnitN\_EffectM\] \[200\] |  | meta                         |  | 0..1                 |  | Controls the parameters that are linked to the metaknob.                                                                                                                                           |  |
...
| \[Channel*N*\] |  | jog                              |  | \-3.0..3.0           |  | Affects relative play speed & direction for short instances (additive & is automatically reset to 0)                                                   |  | waveform                                         |  | [JavaScript engine.scratch functions](MIDI%20scripting#Scratching%20and%20jog%20wheels) |  |
...
| \[Channel*N*\] |  | scratch                          |  | \-3.0..3.0           |  | Affects play speed & direction ([differently whether currently playing or not](https://bugs.launchpad.net/mixxx/+bug/530281)) (multiplicative)         |  | Waveform                                         |  | [JavaScript engine.scratch functions](MIDI%20scripting#Scratching%20and%20jog%20wheels) |  |
| \[Channel*N*\] |  | filter\[201\],\[202\]            |  | binary               |  | Toggles the filter effect                                                                                                                              |  | Filter button                                    |  | [\[QuickEffectRack1\_\[ChannelN\]\_Effect1](#effects-framework)\], enabled              |  |
| \[Channel*N*\] |  | filterDepth\[203\],\[204\]       |  | default              |  | Adjusts the intensity of the filter effect                                                                                                             |  | Filter depth knob                                |  | [\[QuickEffectRack1\_\[ChannelN](#effects-framework)\]\], super1                        |  |
| \[Channel*N*\] |  | filterLow\[205\]                 |  | 0.0..1.0..4.0        |  | Adjusts the gain of the low EQ filter                                                                                                                  |  | LOW knob                                         |  | [\[EqualizerRack1\_\[ChannelN\]\_Effect1](#effects-framework)\], parameter1             |  |
| \[Channel*N*\] |  | filterLowKill\[206\]             |  | binary               |  | Holds the gain of the low EQ to -inf while active                                                                                                      |  | LOW kill knob                                    |  | [\[EqualizerRack1\_\[ChannelN\]\_Effect1](#effects-framework)\], button\_parameter1     |  |
| \[Channel*N*\] |  | filterMid\[207\]                 |  | 0.0..1.0..4.0        |  | Adjusts the gain of the mid EQ filter                                                                                                                  |  | MID knob                                         |  | [\[EqualizerRack1\_\[ChannelN\]\_Effect1](#effects-framework)\], parameter2             |  |
| \[Channel*N*\] |  | filterMidKill\[208\]             |  | binary               |  | Holds the gain of the mid EQ to -inf while active                                                                                                      |  | MID kill knob                                    |  | [\[EqualizerRack1\_\[ChannelN\]\_Effect1](#effects-framework)\], button\_parameter2     |  |
| \[Channel*N*\] |  | filterHigh\[209\]                |  | 0.0..1.0..4.0        |  | Adjusts the gain of the high EQ filter                                                                                                                 |  | HIGH knob                                        |  | [\[EqualizerRack1\_\[ChannelN\]\_Effect1](#effects-framework)\], parameter3             |  |
| \[Channel*N*\] |  | filterHighKill\[210\]            |  | binary               |  | Holds the gain of the high EQ to -inf while active                                                                                                     |  | HIGH kill knob                                   |  | [\[EqualizerRack1\_\[ChannelN\]\_Effect1](#effects-framework)\], button\_parameter3     |  |
| \[Flanger\]    |  | lfoDepth\[211\]                  |  | default              |  | Adjusts the intensity of the flange effect                                                                                                             |  | Depth knob                                       |  | No direct replacement. See [\#effects frameworks](#effects%20frameworks) section        |  |
| \[Flanger\]    |  | lfoDelay\[212\]                  |  | 50..10000            |  | Adjusts the phase delay of the flange effect in microseconds                                                                                           |  | Delay knob                                       |  | No direct replacement. See [\#effects frameworks](#effects%20frameworks) section        |  |
| \[Flanger\]    |  | lfoPeriod\[213\]                 |  | 50000..2000000       |  | Adjusts the wavelength of the flange effect in microseconds                                                                                            |  | LFO knob                                         |  | No direct replacement. See [\#effects frameworks](#effects%20frameworks) section        |  |
| \[Channel*N*\] |  | flanger\[214\]                   |  | binary               |  | Toggles the flange effect                                                                                                                              |  | FLANGER button                                   |  | No direct replacement. See [\#effects frameworks](#effects%20frameworks) section        |  |
| \[Channel*N*\] |  | beatloop\_X\[215\]               |  | toggle               |  | Setup a loop over X beats. A control exists for X = 0.03125, 0.0625, 0.125, 0.25, 0.5, 1, 2, 4, 8, 16, 32, 64                                          |  | A loop is shown over X beats.                    |  | \[Channel*N*\], beatloop\_X\_activate                                                   |  |
