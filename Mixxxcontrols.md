...
| hotcue\_X\_enabled\[66\]                 |  | binary, read-only             |  | 1 if hotcue X is active, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                       |  |                                                                                                                                                                                    |  |
...
| intro\_end\_enabled\[77\]                |  | binary, read-only             |  | 1 if intro end cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                     |  | Intro end button lights up.                                                                                                                                                        |  |
...
| intro\_start\_enabled\[82\]              |  | binary, read-only             |  | 1 if intro start cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                   |  | Intro start button lights up.                                                                                                                                                      |  |
...
| loop\_enabled\[90\]                      |  | binary, read-only             |  | Indicates whether or not a loop is enabled.                                                                                                                                                                                                                                                       |  | Loop in waveform is active.                                                                                                                                                        |  |
...
| outro\_end\_enabled\[108\]               |  | binary, read-only             |  | 1 if outro end cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                     |  | Outro end button lights up.                                                                                                                                                        |  |
...
| outro\_start\_enabled\[113\]             |  | binary, read-only             |  | 1 if outro start cue is set, (position is not -1), 0 otherwise.                                                                                                                                                                                                                                   |  | Outro start button lights up.                                                                                                                                                      |  |
