...
| (6) Sync button          | Syncs the BPM and phase (depending on quantize). Press longer than one second to activate master sync on that deck. | Syncs the phase to that of the other track                        |
| (7) Keylock button       | Enable keylock for the deck                                                                                         |                                                                   |
| (8) Loop knob (turn)     | Halve or double loop size                                                                                           |                                                                   |
| (8) Loop knob (press)    | Toggles the current loop on or off                                                                                  | Enable the loop, seek to its start point, and stop                |
