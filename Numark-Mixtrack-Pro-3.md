...
a [splitter cable](hardware-compatibility.md#splitter%20cables) or
[separate audio interface](hardware-compatibility.md#audio%20interfaces1)
...
separate [USB audio
interface](Hardware-Compatibility.md#USB%20Audio%20Interfaces) with a
...
“**true**” or “**false**” unless specified.
  ...
  - **iCutEnabled**: whether to enable iCut with the jog wheel. See
    [\#platter/jog wheel](#platter/jog-wheel.md) section for details
  - **fastSeekEnabled**: whether to enable fast seeking with the jog
    wheel. See [\#platter/jog wheel](#platter/jog-wheel.md) section for
    details
