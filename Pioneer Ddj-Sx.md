...
| :::                  | 1      | \-             | \[**PAD 1**\] (SLICER mode)  | Toggle Beatloop length index 1 (according parameter set)                                                                                                                           |
| :::                  | 2      | \-             | \[**PAD 2**\] (SLICER mode)  | Toggle Beatloop length index 2 (according parameter set)                                                                                                                           |
| :::                  | 3      | \-             | \[**PAD 3**\] (SLICER mode)  | Toggle Beatloop length index 3 (according parameter set)                                                                                                                           |
| :::                  | 4      | \-             | \[**PAD 4**\] (SLICER mode)  | Toggle Beatloop length index 4 (according parameter set)                                                                                                                           |
| :::                  | 5      | \-             | \[**PAD 5**\] (SLICER mode)  | Toggle Beatloop length index 5 (according parameter set)                                                                                                                           |
| :::                  | 6      | \-             | \[**PAD 6**\] (SLICER mode)  | Toggle Beatloop length index 6 (according parameter set)                                                                                                                           |
| :::                  | 7      | \-             | \[**PAD 7**\] (SLICER mode)  | Toggle Beatloop length index 7 (according parameter set)                                                                                                                           |
| :::                  | 8      | \-             | \[**PAD 8**\] (SLICER mode)  | Toggle Beatloop length index 8 (according parameter set)                                                                                                                           |
| :::                  | 1      | \-             | \[**PAD 1**\] (SAMPLER mode) | Sample deck 1 empty: Load selected track into sample deck 1, track loaded: start play (default, see user options) sample deck 1                                                    |
| :::                  | 1      | \[**SHIFT**\]  | \[**PAD 1**\] (SAMPLER mode) | Sample deck 1 playing: stop deck, sample deck 1 stopped: eject track                                                                                                               |
| :::                  | 2      | \-             | \[**PAD 2**\] (SAMPLER mode) | Sample deck 2 empty: Load selected track into sample deck 2, track loaded: start play (default, see user options) sample deck 2                                                    |
| :::                  | 2      | \[**SHIFT**\]  | \[**PAD 2**\] (SAMPLER mode) | Sample deck 2 playing: stop deck, sample deck 2 stopped: eject track                                                                                                               |
| :::                  | 3      | \-             | \[**PAD 3**\] (SAMPLER mode) | Sample deck 3 empty: Load selected track into sample deck 3, track loaded: start play (default, see user options) sample deck 3                                                    |
| :::                  | 3      | \[**SHIFT**\]  | \[**PAD 3**\] (SAMPLER mode) | Sample deck 3 playing: stop deck, sample deck 3 stopped: eject track                                                                                                               |
| :::                  | 4      | \-             | \[**PAD 4**\] (SAMPLER mode) | Sample deck 4 empty: Load selected track into sample deck 4, track loaded: start play (default, see user options) sample deck 4                                                    |
| :::                  | 4      | \[**SHIFT**\]  | \[**PAD 4**\] (SAMPLER mode) | Sample deck 4 playing: stop deck, sample deck 4 stopped: eject track                                                                                                               |
| :::                  | 5      | \-             | \[**PAD 5**\] (SAMPLER mode) | Sample deck 5 empty: Load selected track into sample deck 5, track loaded: start play (default, see user options) sample deck 5                                                    |
| :::                  | 5      | \[**SHIFT**\]  | \[**PAD 5**\] (SAMPLER mode) | Sample deck 5 playing: stop deck, sample deck 5 stopped: eject track                                                                                                               |
| :::                  | 6      | \-             | \[**PAD 6**\] (SAMPLER mode) | Sample deck 6 empty: Load selected track into sample deck 6, track loaded: start play (default, see user options) sample deck 6                                                    |
| :::                  | 6      | \[**SHIFT**\]  | \[**PAD 6**\] (SAMPLER mode) | Sample deck 6 playing: stop deck, sample deck 6 stopped: eject track                                                                                                               |
| :::                  | 7      | \-             | \[**PAD 7**\] (SAMPLER mode) | Sample deck 7 empty: Load selected track into sample deck 7, track loaded: start play (default, see user options) sample deck 7                                                    |
| :::                  | 7      | \[**SHIFT**\]  | \[**PAD 7**\] (SAMPLER mode) | Sample deck 7 playing: stop deck, sample deck 7 stopped: eject track                                                                                                               |
| :::                  | 8      | \-             | \[**PAD 8**\] (SAMPLER mode) | Sample deck 8 empty: Load selected track into sample deck 8, track loaded: start play (default, see user options) sample deck 8                                                    |
| :::                  | 8      | \[**SHIFT**\]  | \[**PAD 8**\] (SAMPLER mode) | Sample deck 8 playing: stop deck, sample deck 8 stopped: eject track                                                                                                               |
...
| :::                  | 10     | \-             | \[**DECK 4**\]                    | Switches left deck to DECK 4 control and illumination                   |
