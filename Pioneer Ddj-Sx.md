...
| :::                  | 13     | \-             | \[**PARAMETER LEFT**\] (ROLL mode)     | Decrement active looproll-interval parameter set (0-3, see [syntax\#Loop/Loop-Roll parameter sets](syntax#Loop/Loop-Roll%20parameter%20sets)), button LED is illuminated at parameter set 2, 3 |
...
| :::                  | 13     | \-             | \[**PARAMETER LEFT**\] (GROUP2 mode)   | Decrement active loop-interval parameter set (0-3), button LED is illuminated at parameter set 2, 3                                                                                            |
| :::                  | 14     | \-             | \[**PARAMETER RIGHT**\] (ROLL mode)    | Increment active looproll-interval parameter set (0-3), button LED is illuminated at parameter set 1, 3                                                                                        |
...
| :::                  | 14     | \-             | \[**PARAMETER RIGHT**\] (GROUP2 mode)  | Increment active loop-interval parameter set (0-3), button LED is illuminated at parameter set 1, 3                                                                                            |
