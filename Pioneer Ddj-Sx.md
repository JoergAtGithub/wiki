...
| :::                  | 13     | \-             | \[**PARAMETER LEFT**\] (ROLL mode)     | Decrement active looproll-interval parameter set (0-3, see [Loop/Loop-Roll parameter sets](syntax#internal)), button LED is illuminated at parameter set 2, 3                      |
