...
| :::                  | 13     | \-             | \[**PARAMETER LEFT**\] (ROLL mode)     | Decrement active looproll-interval parameter set (0-3, see [Pioneer DDJ-SX](pioneer_ddj-sx)), button LED is illuminated at parameter set 2, 3                                      |
