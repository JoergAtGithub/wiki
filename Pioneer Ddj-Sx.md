...
| :::                  | 13     | \-             | \[**PARAMETER LEFT**\] (ROLL mode)     | Decrement active looproll-interval parameter set (0-3, see [Loop/Loop-Roll parameter sets](syntax#Loop/Loop-Roll)), button LED is illuminated at parameter set 2, 3                |
