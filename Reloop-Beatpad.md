...
section)
  ...
  - **Activate/deactivate:** (Acts-exactly-like-the-**[LOOP](.md#loop)**
    Button)
...
(see-also-**[Instant-FX-mode](.md#Instant-FX-mode)** and **[Sampler
...
``` 
 ...
 - **Effect rack selection** mode (purple LED): each pads selects 1 of the 4 effect racks. The PAD which is lit indicates which effect rack is active (see-**[[.md#EFFECTS-SECTION|EFFECTS SECTION]]**).
```
...
cable](hardware-compatibility.md#splitter%20cable) with the onboard sound
