...
(With rhythmbox, here's an option to make a new playlist; I do that for
the first song (usually named something ingenious like today's date)).

Playlists remain internal to rhythmbox until you export them, which is
simply right-click the playlist, save-as a filename in your home
directory.
