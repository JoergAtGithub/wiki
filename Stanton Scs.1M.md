...
***Note:** the controller is not yet natively supported in Linux. We
have a plan to fix that in a future Mixxx version.*
...
### Instructions for v1.8.x & prior

[See a walk-through video\!](http://www.youtube.com/watch?v=crJksOEuTx0)

1.  Do the following depending on your OS:
...
<!-- end list -->
  ...
  - **Windows & Mac**:
    1.  Download & unpack the
        ...
        DaRouter preset
    2.  Start DaRouter and browse to where you saved the preset. Select
        & open it.
...
1.  Download the files below for your version of Mixxx.
2.  Save the files into:
...
1.  Start Mixxx, open Preferences, choose Input Controllers, the
    "Stanton SCS.1m" mapping, and the "From SCS.1" device. Click OK and
    you're good to go.
...
(If you get a `Warning: No <midino> defined in MIDI map node: "control"`
just click OK.)
