...
## Mixxx says the sample format is not supported when configuring the sound card (GNU/Linux)

Open a console/terminal emulator and run `export PA_ALSA_PLUGHW=1`
