...
Support for [colored hotcues](MIDI-scripting.md#color%20API) was added.
...
# Mixxx 2.1
  ...
  - [Components JS](Components-JS.md) library was introduced to make
    writing JavaScript mappings easier. It provides an [Components
    JS\#EffectUnit](Components-JS.md#EffectUnit) object that makes it
